...
ALLOWED_HOSTS = ['10.10.10.10', 'localhost', '127.0.0.1']
#Custom User Model
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://10.10.10.56:5174",
    
]

# Pour le développement, autoriser toutes les origines
CORS_ALLOW_ALL_ORIGINS = False # ATTENTION: Seulement pour le développement
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@ohb-formation.dz')
